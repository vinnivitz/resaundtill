...
>
	<FooterCopyright by="Vinzenz Fuhrmann." {year} spanClass="text-slate-400 text-xs md:text-md" />
	...
	>
		<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" aria-label="GitHub">
			<path
				fill-rule="evenodd"
