<div class="m-5 pt-10 xl:m-10">
	<h1 class="text-3xl">Haftungsausschluss</h1>
	<h3 class=" mt-5 text-xl">Haftung für Inhalte</h3>
	<p class="mt-3">
	...
	<h3 class="mt-5 text-xl">Haftung für Links</h3>
	<p class="mt-3">
	...
	<h3 class="mt-5 text-xl">Urheberrecht</h3>
	<p class="mt-3">
	...
	<h1 class="mt-5 text-3xl">Datenschutz</h1>
	<p class="mt-3">
